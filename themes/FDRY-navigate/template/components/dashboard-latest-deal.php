<?php
$args = array(
  'post_type' => 'deal', // - retrieves any type except revisions and types with 'exclude_from_search' set to true.
...
<section class="component-latest-deal">
  <div class="content-block">
    <div class="dashboard-main-buble">
      
      <div class="buble-info">
        <h3 class="title"><i><?php get_template_part( 'svg-template/svg', 'handshake' ) ?></i>Latest Deals</h3>
        <p>Companies looking for investors</p>
      </div>
        ...
        <?php while ( $the_query->have_posts() ) : $the_query->the_post() ; ?>
          ...
          <article class="dashboard-inner-buble">
            <div class="deal-title">
              ...
              <span class="money"><?= get_field('raised', $post_id ) ?></span>
            </div>
